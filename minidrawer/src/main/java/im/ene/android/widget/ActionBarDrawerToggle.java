...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
  ...
  private final MiniDrawerLayout mDrawerLayout;
   ...
   * for accessibility
   */
  public ActionBarDrawerToggle(Activity activity, MiniDrawerLayout drawerLayout,
   ...
   * for accessibility
   */
  public ActionBarDrawerToggle(Activity activity, MiniDrawerLayout drawerLayout, Toolbar toolbar,
      @StringRes int openDrawerContentDescRes, @StringRes int closeDrawerContentDescRes) {
  ...
  <T extends Drawable & DrawerToggle> ActionBarDrawerToggle(Activity activity, Toolbar toolbar,
      MiniDrawerLayout drawerLayout, T slider, @StringRes int openDrawerContentDescRes,
  ...
  public void syncState() {
    ...
    if (mDrawerIndicatorEnabled) {
      setActionBarUpIndicator((Drawable) mSlider,
          mDrawerLayout.isDrawerOpen() ? mCloseDrawerContentDescRes : mOpenDrawerContentDescRes);
    }
  }
  ...
  private void toggle() {
    if (mDrawerLayout.isDrawerVisible()) {
  ...
  private static class HoneycombDelegate implements Delegate {
    ...
    @Override public Drawable getThemeUpIndicator() {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB) @Override public boolean isNavigationVisible() {
      final ActionBar actionBar = mActivity.getActionBar();
    ...
    public void setActionBarUpIndicator(Drawable themeImage, int contentDescRes) {
      ...
      mSetIndicatorInfo =
          ActionBarDrawerToggleHoneycomb.setActionBarUpIndicator(mSetIndicatorInfo, mActivity,
              themeImage, contentDescRes);
      mActivity.getActionBar().setDisplayShowHomeEnabled(false);
    }

    @Override public void setActionBarDescription(int contentDescRes) {
      mSetIndicatorInfo =
          ActionBarDrawerToggleHoneycomb.setActionBarDescription(mSetIndicatorInfo, mActivity,
              contentDescRes);
    }
  }
  ...
  static class ToolbarCompatDelegate implements Delegate {
    ...
    @Override public void setActionBarDescription(@StringRes int contentDescRes) {
      if (contentDescRes == 0) {
    ...
    @Override public Context getActionBarThemedContext() {
      return mToolbar.getContext();
    }

    @Override public boolean isNavigationVisible() {
      return true;
    }
  }
